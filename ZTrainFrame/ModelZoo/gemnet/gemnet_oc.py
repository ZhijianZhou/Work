...
from ZTrainFrame.ModelZoo.gemnet.common.utils import (
    get_max_neighbors_mask,
    scatter_det,
)
from ZTrainFrame.ModelZoo.gemnet.base import BaseModel
from ZTrainFrame.ModelZoo.gemnet.scaling.compat import load_scales_compat
...
class GemNetOC(BaseModel):
    ...
    def subselect_edges(
        ...
        #     raise ValueError(
        #         f"An image has no neighbors: id={data.mol_name[empty_image]}, "
        #         f"sid={data.mol_name[empty_image]}, fid={data.mol_name[empty_image]}"
        #     )
        return subgraph
